     ...
     <div class="gap-4 flex justify-between items-center">
        ...
        <i class="fa-solid fa-bars p-3 text-xl"></i>
         ...
         <div class="text-[#F4F6F9] flex items-center gap-2">
             ...
             <SignSection v-if="!store.isRegisteration" @isRegister="e => isRegisterationModal = e" @isLogin = "e => isLoginModal = e"/>
             <AuthSection :user-name="store.user?.name" v-if="store.isRegisteration"/>
         </div>
     </div>
