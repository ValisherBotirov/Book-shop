    ...
    <div class="md:w-[50%] w-[100%]">
      <ul>
        <li class="flex justify-between md:px-10 text-start items-center">
          <span>Brand</span><span>Apple</span>
        </li>
        <li class="flex justify-between md:px-10 text-start items-center">
          <span>Doimiy xotira</span><span>120 GB SSD</span>
        </li>
        <li class="flex justify-between md:px-10 text-start items-center">
          <span>RAM</span><span>32 GB</span>
        </li>
        <li class="flex justify-between md:px-10 text-start items-center">
          <span>Video Carta</span><span>NVIDIA 8 GB</span>
        </li>
        <li class="flex justify-between md:px-10 text-start items-center">
          <span>Display</span><span>LPC </span>
        </li>
        <li class="flex justify-between md:px-10 text-start items-center">
          <span>Protsessor</span><span>Core i 9</span>
        </li>
        <li class="flex justify-between md:px-10 text-start items-center">
          <span>Yadro</span><span>16</span>
        </li>
        <li class="flex justify-between md:px-10 text-start items-center">
          <span>Quvvat</span><span>220 A</span>
        </li>
        <li class="flex justify-between md:px-10 text-start items-center">
...
<!--      </ul>-->
    ...
    >
      <div class="flex items-end gap-3 relative">
        <h1 class="font-medium text-2xl">150 000 so'm</h1>
        <del class="font-medium text-xl opacity-[0.5]">180 000 so'm</del>
        <strong
      ...
      <div class="flex items-center gap-3 pt-4 font-medium">
        <p class="text-2xl">Umumiy so'm:</p>
        <h2 class="text-2xl">40 000 so'm</h2>
      </div>
      ...
      <div class="flex flex-col gap-3 pt-5">
        <SaveBasket class="w-full"> Savatga qo'shish </SaveBasket>
        <SaveBasket
          class="w-full"
          :icon="false"
          custom-class="bg-[#79a206] !text-white border-none !hover:!bg-[#3E444A]"
        >
          Joyida sotib olish
        </SaveBasket>
      </div>
